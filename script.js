...
document.querySelectorAll('.download-btn').forEach(btn => {
    btn.addEventListener('click', function(e) {
        ...
        // Check if it's a store download button
        if (this.querySelector('.download-store')) {
            ...
            setTimeout(() => {
                ...
                showNotification(`Please visit ${store} to download HustleBase`, 'info');
            }, 1000);
        }
    });
});
...
progressBar.style.cssText = `
    ...
    width: 0%;
    height: 3px;
    background: linear-gradient(90deg, var(--rose-red), var(--pacific-cyan));
    z-index: 10001;
...
document.querySelectorAll('a, button, input, textarea').forEach(element => {
    element.addEventListener('focus', function() {
        this.style.outline = '2px solid var(--pacific-cyan)';
